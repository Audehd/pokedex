...
const UserSignUpForm = () => {
  ...
  const handleSubmit = (ev) => {
    ...
    if (
      ...
      email.current.style.border = "DeepPink 2px solid";
      email.current.focus();
      ...
      username.current.style.border = "DeepPink 2px solid";
    ...
    //check if password is at least 6 characters
      ...
      password.current.style.border = "DeepPink 2px solid";
    ...
    //check if passwords match
      ...
      confirmPassword.current.style.border = "DeepPink 2px solid";
